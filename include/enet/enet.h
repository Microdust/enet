...
typedef struct _ENetHost
{
   ...
   enet_uint32			applicationId;				/**< MicroNet, application id for connection*/
...
ENET_API ENetHost * enet_host_create (const ENetAddress *, size_t, size_t, enet_uint32, enet_uint32, enet_uint32);
